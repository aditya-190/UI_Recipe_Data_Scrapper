...
collection = db.collection("figma")
...
def GoToLink(page, category):
    ...
    for item in ui:
        try:
            ...
            # Going to next Page in Figma Crush.
            ...
            if (author != "") and downloadUrl != "":
                ...
                if inputGoesHere == 'WRITE':
                    ...
                    print("Figma -> " + str(collectionCounter))
        ...
        print("Total Scrap = " + str(totalCount) + " Error = " + str(errorCount) + " Skip = " + str(skipCount) + " Added = " + str(addedCount) + " Precision Rate = " + str((addedCount/totalCount) * 100))
...
def fetchUIRelatedPage(inputUIToFetch, start, end):
    ...
    if inputUIToFetch == "Website":
        baseUrl = "https://www.figmacrush.com/figma-website-templates/page/"
        pageCategory = "Website"
        
    elif inputUIToFetch == "Mobile":
        baseUrl = "https://www.figmacrush.com/figma-mobile-templates/page/"
        pageCategory = "Mobile"
        
    elif inputUIToFetch == "Miscellaneous":
        baseUrl = "https://www.figmacrush.com/misc-ui-resources-figma/page/"
        pageCategory = "Miscellaneous"
        
    elif inputUIToFetch == "UI Kits":
        baseUrl = "https://www.figmacrush.com/free-figma-ui-kits/page/"
        pageCategory = "Miscellaneous"
        
    elif inputUIToFetch == "Wireframes":
        baseUrl = "https://www.figmacrush.com/figma-wireframe-kits/page/"
        pageCategory = "Miscellaneous"
        
    elif inputUIToFetch == "Icons":
        baseUrl = "https://www.figmacrush.com/figma-icons/page/"
        pageCategory = "Miscellaneous"
        
    elif inputUIToFetch == "Illustrations":
        baseUrl = "https://www.figmacrush.com/figma-illustrations/page/"
        pageCategory = "Miscellaneous"
        
    elif inputUIToFetch == "Animations":
        baseUrl = "https://www.figmacrush.com/figma-animation-templates/page/"
        pageCategory = "Miscellaneous"
...
def ReadAndStore():
    ...
    with open("figma.json", "r") as readMyFile:
...
if inputGoesHere == "READ":
    ...
    if inputGoesHere == 'WRITE':
        with open("figma.json", "w") as writeMyFile:
